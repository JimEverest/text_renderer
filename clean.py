...
def parse_args():
    ...
    parser.add_argument("--output", default="example_data/output1/")
...
if __name__=="__main__":
    ...
    #2. Generate
    os.system("python /home/jim/AI/text_renderer/main.py --config "+args.config+" --dataset img --num_processes 8 --log_period 10")
